...
<body class="bg-white">
    <div class="max-w-7xl mx-auto my-8 overflow-hidden flex flex-col gap-8 bg-white">
        <!-- Hero Section -->
        <div class="relative h-80 lg:h-96 bg-cover bg-center bg-no-repeat rounded-2xl overflow-hidden"
            ...
            <div class="absolute bottom-12 left-8 z-10">
                <h1 class="poppins-font text-xl lg:text-3xl font-bold text-white tracking-wide">Permohonan Doa</h1>
            </div>
        </div>
