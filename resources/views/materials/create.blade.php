...
<div class="container mx-auto mt-10 p-5 max-w-2xl">
    <h1 class="text-3xl font-bold text-gray-700 mb-6">Add New PDF Link</h1>

    <form action="{{ route('admin.materials.insert') }}" method="POST" class="bg-white p-6 rounded-lg shadow-md">
        @csrf
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="url" name="url" id="url" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700" required>
        </div>
        <div class="mb-4">
            <label for="published_date" class="block text-gray-700 font-bold mb-2">Published Date</label>
            <input type="date" name="published_date" id="published_date" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700">
        </div>
        <div class="mb-6">
